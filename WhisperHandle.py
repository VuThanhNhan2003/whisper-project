...
from whisper_transcribe import input_file
...
#Handle
def process_video_transcription(audio: str| BinaryIO| ndarray,file_name: str, language: str, config: ModelConfig)-> Dict[str, any]:
